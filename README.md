...
That file can me modified but make sure you follow the right syntaxt: <br/>`EmployeeId FirstName LastName Password RoleId`. 
...
That't it. Thanks for visiting the repository and I hope you will enjoy using and playing with the app.<br/>
